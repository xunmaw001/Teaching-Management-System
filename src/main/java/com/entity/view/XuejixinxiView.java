...
public class XuejixinxiView extends XuejixinxiEntity implements Serializable {
	...
	* 学籍状态的值
	*/
	@ColumnInfo(comment="学籍状态的字典表值",type="varchar(200)")
	private String zhuangValue;
	...
	* 获取： 学籍状态的值
	*/
	public String getZhuangValue() {
		return zhuangValue;
	}
	/**
	* 设置： 学籍状态的值
	*/
	public void setZhuangValue(String zhuangValue) {
		this.zhuangValue = zhuangValue;
	}
	...
	public String toString() {
		return "XuejixinxiView{" +
			", zhuangValue=" + zhuangValue +
