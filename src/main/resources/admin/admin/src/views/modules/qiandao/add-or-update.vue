    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="签到标题" prop="qiandaoName">
                       <el-input v-model="ruleForm.qiandaoName"
                                 placeholder="签到标题" clearable  :readonly="ro.qiandaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="签到标题" prop="qiandaoName">
                           <el-input v-model="ruleForm.qiandaoName"
                                     placeholder="签到标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
