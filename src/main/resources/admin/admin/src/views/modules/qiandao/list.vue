        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '签到标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.qiandaoName" placeholder="签到标题" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jiaoxueguanli/upload/qiandaoMuBan.xls"
                        >批量导入上课签到数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('qiandao','导入导出')"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.qiandaoName!= '' && this.searchForm.qiandaoName!= undefined) {
                    params['qiandaoName'] = '%' + this.searchForm.qiandaoName + '%'
                }
